/* English Fun Start · Selector de idiomas · Actualización 33
...
(function(){
  ...
  function open(){
    ...
    box.innerHTML=`<div class="language-backdrop"></div><div class="language-panel" role="dialog" aria-modal="true">
      <div class="language-logo">🌍</div><h2>¿Qué idioma quieres practicar?</h2><p>Elige un idioma para entrar en su sección de aprendizaje.</p><div class="language-version">English Fun Start · Actualización 33 · v3.3.0</div>
